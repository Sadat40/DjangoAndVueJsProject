...
with open(os.path.join(
        BASE_DIR, 'consoles', 'secrets.json')) as f:
...
SECRET_KEY = 'django-insecure-l$+1bfvj9el(p-j$a_$af%69oo0d#fcy2ffmf#5i))mvc@#&c^'
...
STATIC_URL = 'static/'
STATIC_ROOT = os.path.join(os.path.dirname(BASE_DIR), "consoles_static")
